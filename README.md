# Backbone -  Sku Usage Collector API PHP Client

## Introduction

The  Sku Usage Collector API PHP Client enables you to work with the  Sku Usage Collector API.
...
The library can be used to communicate with the  Sku Usage Collector Resource Server.
